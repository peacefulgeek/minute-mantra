...
app.get('/api/health', (req, res) => {
  res.json({ status: 'ok', version: 'v10-purple-audio-fix', timestamp: new Date().toISOString() });
});
...
app.listen(PORT, () => {
  console.log(`Minute Mantra server v10-purple-audio-fix running on port ${PORT}`);
});
